...
export interface Customer { id: string; nombre: string; email?: string; telefono?: string; ruc?: string; extra_club_numero?: string | null; empresa_vinculada_nombre?: string | null; empresa_vinculada_ruc?: string | null; razon_social?: string; nombre_fantasia?: string | null; ci?: string; direccion?: string; ciudad?: string; departamento?: string | null; condicion_iva?: string | null; pago_default?: string | null; contacto?: string | null; tipo?: string; tipo_persona?: string; activo?: boolean; es_agente_retencion?: boolean; porcentaje_retencion_iva?: number; saldo_pendiente?: number; limite_credito?: number; credito_limite?: number; credito_usado?: number; created_at?: string; updated_at?: string }
...
export interface AccountsReceivable { id: string; company_id?: string; customer_id?: string; customer?: Customer; customer_name?: string; customer_ruc?: string; customer_telefono?: string; sale_id?: string; numero_documento?: string; saldo?: number; saldo_pendiente?: number; limite_credito?: number; porcentaje_uso?: number; monto_original?: number; fecha_emision?: string; fecha_vencimiento?: string; dias_mora?: number; estado?: string; activo?: boolean; created_at?: string; updated_at?: string }
