...
export interface KioskProductLookup { id: string; nombre: string; sku?: string | null; codigo_barra?: string | null; precio_venta: number; imagen_url?: string | null; categoria_nombre?: string | null; tipo_venta?: string | null; escalas: KioskPriceTier[]; packs: KioskPackInfo[]; escaneado_como_pack?: string | null; en_promocion?: boolean; badge_promo?: string; ahorro_unitario?: number; ahorro_porcentaje?: number; precio_regular?: number; limite_por_compra?: number; mensaje_dias?: string; promocion_nombre?: string | null; valido_hasta?: string | null }
