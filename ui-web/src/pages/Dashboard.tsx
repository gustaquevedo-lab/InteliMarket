...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#070a13] text-slate-100 p-2 sm:p-4 md:p-6 lg:p-8 space-y-8 max-w-[1750px] mx-auto pb-16 font-sans relative overflow-hidden selection:bg-indigo-500 selection:text-white">
      
      {/* Background Ambient Glow & Cyber Grid Meshes */}
      <div className="fixed inset-0 pointer-events-none z-0">
        <div className="absolute -top-40 left-1/4 w-[650px] h-[650px] bg-indigo-600/10 rounded-full blur-[140px]" />
        <div className="absolute top-1/3 -right-40 w-[600px] h-[600px] bg-emerald-600/10 rounded-full blur-[140px]" />
        <div className="absolute -bottom-40 left-1/3 w-[700px] h-[700px] bg-amber-600/10 rounded-full blur-[160px]" />
      ...
      <div className="relative z-10 space-y-8">
        ...
        ────────────────────────────────────────────────────────────────────────── */}
        <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-5 p-6 rounded-3xl bg-slate-900/80 backdrop-blur-2xl border border-slate-800/90 shadow-[0_0_50px_rgba(0,0,0,0.6)]">
          
          <div className="space-y-2">
            <div className="flex flex-wrap items-center gap-3">
              <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full text-xs font-black bg-emerald-500/15 text-emerald-400 border border-emerald-500/30 shadow-[0_0_15px_rgba(16,185,129,0.2)]">
            ...
            <div className="flex flex-wrap items-baseline gap-3">
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-black tracking-tight text-white flex items-center gap-3">
                {greeting}, <span className="bg-gradient-to-r from-white via-indigo-200 to-indigo-400 bg-clip-text text-transparent">{user?.nombre && !user.nombre.toLowerCase().includes("admin") ? user.nombre : "Gustavo"}</span>
              </h1>
              {selectedBranch ? (
                <span className="text-xs px-3.5 py-1 rounded-xl bg-teal-500/20 text-teal-300 font-black border border-teal-500/40 flex items-center gap-2 shadow-[0_0_15px_rgba(20,184,166,0.2)]">
                  <Store className="w-3.5 h-3.5" />
                  {selectedBranch.codigo} · {selectedBranch.nombre}
                </span>
              ) : (
                <span className="text-xs px-3.5 py-1 rounded-xl bg-indigo-500/20 text-indigo-300 font-black border border-indigo-500/40 flex items-center gap-2 shadow-[0_0_15px_rgba(99,102,241,0.2)]">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <div className="bg-slate-950/90 p-1.5 rounded-2xl flex items-center gap-1.5 border border-slate-800 shadow-inner">
              {(["hoy", "semana", "mes", "anio"] as TimeRange[]).map((r) => (
                <button
                  ...
                  className={`px-4 py-2 rounded-xl text-xs font-black transition-all cursor-pointer ${
                    timeRange === r
                      ? "bg-gradient-to-r from-indigo-600 to-indigo-500 text-white shadow-[0_0_20px_rgba(99,102,241,0.4)] border border-indigo-400/50 scale-[1.03]"
            ...
            <button
              ...
              disabled={refreshing}
              className="p-3 rounded-2xl bg-slate-900 hover:bg-slate-800 text-slate-300 hover:text-white border border-slate-700/80 shadow-md hover:shadow-indigo-500/20 transition-all flex items-center justify-center cursor-pointer active:scale-95 group"
              title="Recalcular Métricas"
            >
              <RefreshCw className={`w-4 h-4 ${refreshing ? "animate-spin text-indigo-400" : "group-hover:rotate-180 transition-all duration-500"}`} />
            </button>
          </div>
        ...
        <div className="space-y-5">
          <div className="p-8 rounded-3xl bg-gradient-to-br from-slate-950 via-[#0a0f1d] to-[#070b14] border border-indigo-500/40 shadow-[0_0_60px_rgba(99,102,241,0.12)] relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            ...
            <div className="p-6 rounded-3xl bg-slate-900/90 backdrop-blur-2xl border border-indigo-500/30 hover:border-indigo-500/60 shadow-[0_0_30px_rgba(99,102,241,0.1)] hover:shadow-[0_0_40px_rgba(99,102,241,0.25)] transition-all duration-300 flex flex-col justify-between group">
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-2xl bg-indigo-500/20 text-indigo-400 border border-indigo-500/30 flex items-center justify-center font-bold shadow-[0_0_15px_rgba(99,102,241,0.3)] group-hover:scale-110 transition-all">
                      <TrendingUp className="w-5 h-5" />
                    </div>
                    <div>
                      <h3 className="text-xs font-mono font-black text-white uppercase tracking-wider">Gerente Comercial IA</h3>
                      <span className="text-xs text-emerald-400 font-extrabold font-mono">Pacing en Meta (+3.8%)</span>
                    </div>
                  </div>
              ...
              <div className="pt-4 mt-3 border-t border-slate-800/80">
                <button onClick={() => navigate("/commercial-agent")} className="text-xs font-mono font-bold text-indigo-400 hover:text-indigo-300 flex items-center gap-2 group-hover:translate-x-1.5 transition-all cursor-pointer">
            ...
            <div className="p-6 rounded-3xl bg-slate-900/90 backdrop-blur-2xl border border-teal-500/30 hover:border-teal-500/60 shadow-[0_0_30px_rgba(20,184,166,0.1)] hover:shadow-[0_0_40px_rgba(20,184,166,0.25)] transition-all duration-300 flex flex-col justify-between group">
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-2xl bg-teal-500/20 text-teal-400 border border-teal-500/30 flex items-center justify-center font-bold shadow-[0_0_15px_rgba(20,184,166,0.3)] group-hover:scale-110 transition-all">
                      <Wallet className="w-5 h-5" />
                    </div>
                    <div>
                      <h3 className="text-xs font-mono font-black text-white uppercase tracking-wider">Gerente Financiero IA</h3>
                      <span className="text-xs text-teal-400 font-extrabold font-mono">Calce Operativo Óptimo</span>
                    </div>
                  </div>
              ...
              <div className="pt-4 mt-3 border-t border-slate-800/80">
                <button onClick={() => navigate("/finance-agent")} className="text-xs font-mono font-bold text-teal-400 hover:text-teal-300 flex items-center gap-2 group-hover:translate-x-1.5 transition-all cursor-pointer">
            ...
            <div className="p-6 rounded-3xl bg-slate-900/90 backdrop-blur-2xl border border-purple-500/30 hover:border-purple-500/60 shadow-[0_0_30px_rgba(168,85,247,0.1)] hover:shadow-[0_0_40px_rgba(168,85,247,0.25)] transition-all duration-300 flex flex-col justify-between group">
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-2xl bg-purple-500/20 text-purple-400 border border-purple-500/30 flex items-center justify-center font-bold shadow-[0_0_15px_rgba(168,85,247,0.3)] group-hover:scale-110 transition-all">
                      <Users className="w-5 h-5" />
                    </div>
                    <div>
                      <h3 className="text-xs font-mono font-black text-white uppercase tracking-wider">Gerente de Marketing IA</h3>
                      <span className="text-xs text-purple-400 font-extrabold font-mono">14 Cuentas Top en Alza</span>
                    </div>
                  </div>
              ...
              <div className="pt-4 mt-3 border-t border-slate-800/80">
                <button onClick={() => navigate("/marketing")} className="text-xs font-mono font-bold text-purple-400 hover:text-purple-300 flex items-center gap-2 group-hover:translate-x-1.5 transition-all cursor-pointer">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="p-7 rounded-3xl bg-slate-900/90 backdrop-blur-2xl border border-indigo-500/30 hover:border-indigo-500/70 shadow-[0_0_35px_rgba(99,102,241,0.15)] hover:shadow-[0_0_50px_rgba(99,102,241,0.3)] transition-all duration-300 flex flex-col justify-between group relative overflow-hidden">
            <div className="absolute top-0 right-0 w-40 h-40 bg-indigo-500/10 rounded-full blur-2xl group-hover:bg-indigo-500/20 transition-all pointer-events-none" />
            
            <div className="flex items-start justify-between relative z-10">
              <div className="space-y-1.5">
                <div className="flex items-center gap-2">
                  <span className="text-xs font-mono font-black text-slate-400 uppercase tracking-wider">Ventas Netas</span>
                ...
                <div className="text-xs font-mono text-slate-400 font-bold truncate max-w-[220px]" title={formatPYG(totalVentasMonto)}>
                  {formatPYG(totalVentasMonto)}
                </div>
              </div>
              <div className="w-14 h-14 rounded-2xl bg-indigo-500/20 border border-indigo-500/40 text-indigo-400 flex items-center justify-center font-bold shadow-[0_0_20px_rgba(99,102,241,0.3)] group-hover:scale-110 group-hover:bg-indigo-600 group-hover:text-white transition-all duration-300">
                <DollarSign className="w-7 h-7" />
              </div>
            </div>

            <div className="mt-6 pt-4 border-t border-slate-800 flex items-center justify-between text-xs relative z-10">
          ...
          <div className="p-7 rounded-3xl bg-slate-900/90 backdrop-blur-2xl border border-teal-500/30 hover:border-teal-500/70 shadow-[0_0_35px_rgba(20,184,166,0.15)] hover:shadow-[0_0_50px_rgba(20,184,166,0.3)] transition-all duration-300 flex flex-col justify-between group relative overflow-hidden">
            <div className="absolute top-0 right-0 w-40 h-40 bg-teal-500/10 rounded-full blur-2xl group-hover:bg-teal-500/20 transition-all pointer-events-none" />

            <div className="flex items-start justify-between relative z-10">
              <div className="space-y-1.5">
                <div className="flex items-center gap-2">
                  <span className="text-xs font-mono font-black text-slate-400 uppercase tracking-wider">Margen Bruto Directo</span>
                  <span className="px-2 py-0.5 rounded-md bg-teal-500/20 text-teal-300 text-[10px] font-black uppercase border border-teal-500/40 font-mono">
                    8.3% Directo
                  </span>
                </div>
                <div className="text-3xl sm:text-4xl font-black text-teal-400 tracking-tight font-mono">
                  {margenBrutoGs > 0 ? formatCompactPYG(margenBrutoGs) : "Gs. 0"}
                </div>
                <div className="text-xs font-mono text-slate-400 font-bold">
                  + Rebates: <span className="text-emerald-400 font-black">11.3% Total (Gs. 698M)</span>
                </div>
              </div>
              <div className="w-14 h-14 rounded-2xl bg-teal-500/20 border border-teal-500/40 text-teal-400 flex items-center justify-center font-bold shadow-[0_0_20px_rgba(20,184,166,0.3)] group-hover:scale-110 group-hover:bg-teal-600 group-hover:text-white transition-all duration-300">
                <TrendingUp className="w-7 h-7" />
              </div>
            </div>

            <div className="mt-6 pt-4 border-t border-slate-800 flex items-center justify-between text-xs relative z-10">
              <span className="text-teal-400 font-extrabold text-xs flex items-center gap-1.5 font-mono">
          ...
          <div className="p-7 rounded-3xl bg-slate-900/90 backdrop-blur-2xl border border-amber-500/40 hover:border-amber-500/80 shadow-[0_0_40px_rgba(245,158,11,0.2)] hover:shadow-[0_0_60px_rgba(245,158,11,0.35)] transition-all duration-300 flex flex-col justify-between group relative overflow-hidden">
            <div className="absolute top-0 right-0 w-44 h-44 bg-amber-500/15 rounded-full blur-2xl group-hover:bg-amber-500/25 transition-all pointer-events-none" />

            <div className="flex items-start justify-between relative z-10">
              <div className="space-y-1.5">
                <div className="flex items-center gap-2">
                  <span className="text-xs font-mono font-black text-amber-400 uppercase tracking-wider">Avance Volumen PARESA</span>
                  <span className="px-2 py-0.5 rounded-full bg-emerald-500/20 text-emerald-300 text-[10px] font-black border border-emerald-500/40 shadow-[0_0_10px_rgba(16,185,129,0.2)]">
                    94.41% MTD
                  </span>
                </div>
                <div className="text-3xl sm:text-4xl font-black text-white tracking-tight font-mono">
                ...
                <div className="text-xs font-mono text-amber-300 font-black pt-1">
                  Rebate Ganado: Gs. 146.439.074 (+4.5%)
                </div>
              </div>
              <div className="w-14 h-14 rounded-2xl bg-amber-500/20 border border-amber-500/40 text-amber-400 flex items-center justify-center font-bold shadow-[0_0_20px_rgba(245,158,11,0.3)] group-hover:scale-110 group-hover:bg-amber-500 group-hover:text-black transition-all duration-300">
                <Award className="w-7 h-7" />
              </div>
            </div>

            <div className="mt-5 pt-3.5 border-t border-amber-900/40 flex items-center justify-between relative z-10">
              <button
                onClick={() => navigate("/supplier-kpis")}
                className="w-full py-2.5 px-4 rounded-2xl bg-gradient-to-r from-amber-500 via-amber-400 to-orange-500 text-slate-950 font-black text-xs uppercase tracking-wider flex items-center justify-center gap-2 transition-all shadow-[0_0_25px_rgba(245,158,11,0.35)] hover:shadow-[0_0_35px_rgba(245,158,11,0.6)] hover:scale-[1.02] cursor-pointer"
              >
          ...
          <div className="p-7 rounded-3xl bg-slate-900/90 backdrop-blur-2xl border border-purple-500/30 hover:border-purple-500/70 shadow-[0_0_35px_rgba(168,85,247,0.15)] hover:shadow-[0_0_50px_rgba(168,85,247,0.3)] transition-all duration-300 flex flex-col justify-between group relative overflow-hidden">
            <div className="absolute top-0 right-0 w-40 h-40 bg-purple-500/10 rounded-full blur-2xl group-hover:bg-purple-500/20 transition-all pointer-events-none" />

            <div className="flex items-start justify-between relative z-10">
              <div className="space-y-1.5">
                <span className="text-xs font-mono font-black text-slate-400 uppercase tracking-wider">Facturas Emitidas</span>
                <div className="text-3xl sm:text-4xl font-black text-white tracking-tight font-mono">
                  {totalTickets.toLocaleString()} <span className="text-base font-bold text-slate-400">docs</span>
                </div>
                <div className="text-xs font-mono text-slate-400 font-bold">
                  Ticket Medio: <span className="text-white font-black">{formatCompactPYG(ticketPromedio)}</span>
                </div>
              </div>
              <div className="w-14 h-14 rounded-2xl bg-purple-500/20 border border-purple-500/40 text-purple-400 flex items-center justify-center font-bold shadow-[0_0_20px_rgba(168,85,247,0.3)] group-hover:scale-110 group-hover:bg-purple-600 group-hover:text-white transition-all duration-300">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-7 p-8 rounded-3xl bg-slate-900/90 backdrop-blur-2xl border border-slate-800/90 shadow-[0_0_40px_rgba(0,0,0,0.5)] flex flex-col justify-between">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
              <div>
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-2xl bg-indigo-500/20 text-indigo-400 border border-indigo-500/30 flex items-center justify-center font-bold shadow-[0_0_15px_rgba(99,102,241,0.3)]">
                    <TrendingUp className="w-5 h-5" />
                  </div>
                  <div>
                    <h3 className="text-lg sm:text-xl font-black text-white tracking-tight">Pacing Comercial & Curva de Ventas</h3>
                    <p className="text-xs text-slate-400">Comparativa contra Meta (+5%), Mes Anterior y Año Anterior</p>
                  </div>
                </div>
              </div>

              {/* Selector de Rango */}
              <div className="flex items-center p-1.5 bg-slate-950 rounded-2xl border border-slate-800 self-start sm:self-auto shadow-inner">
                <button
            ...
            <div className="flex flex-wrap items-center gap-2.5 mb-6">
              ...
              >
                <span className={`w-2.5 h-2.5 rounded-full ${showActual ? "bg-indigo-400 shadow-[0_0_8px_#818cf8]" : "bg-slate-700"}`} />
                Venta Actual
              </button>
              ...
              <button
                ...
                className={`px-3.5 py-1.5 rounded-xl text-xs font-mono font-black transition-all flex items-center gap-2 border cursor-pointer ${
                  showMeta
                    ? "bg-slate-700/40 border-slate-600 text-slate-200 shadow-2xs"
                    : "bg-transparent border-transparent text-slate-500 hover:text-slate-300"
                }`}
              >
                <span className={`w-2.5 h-2.5 rounded-sm ${showMeta ? "bg-slate-400" : "bg-slate-700"}`} />
                Meta Barras (+5%)
              </button>
              ...
              <button
                ...
                className={`px-3.5 py-1.5 rounded-xl text-xs font-mono font-black transition-all flex items-center gap-2 border cursor-pointer ${
                  showPrevMonth
                    ? "bg-sky-500/20 border-sky-500/50 text-sky-300 shadow-[0_0_15px_rgba(14,165,233,0.2)]"
                    : "bg-transparent border-transparent text-slate-500 hover:text-slate-300"
                }`}
              >
                <span className={`w-2.5 h-2.5 rounded-full ${showPrevMonth ? "bg-sky-400 shadow-[0_0_8px_#38bdf8]" : "bg-slate-700"}`} />
                Mes Anterior
              </button>
              ...
              >
                <span className={`w-2.5 h-2.5 rounded-full border border-dashed border-amber-500 ${showPrevYear ? "bg-amber-400 shadow-[0_0_8px_#fbbf24]" : "bg-slate-700"}`} />
                Año Anterior
              </button>
            </div>
              ...
              {salesTrendData.length === 0 ? (
                ...
                <ResponsiveContainer width="100%" height="100%">
                  <ComposedChart data={salesTrendData} margin={{ top: 10, right: 10, left: -10, bottom: 0 }}>
                    <defs>
                      <linearGradient id="pacingGradientCyber" x1="0" y1="0" x2="0" y2="1">
                    ...
                    <Tooltip
                      content={({ active, payload, label }) => {
                        if (active && payload && payload.length) {
                          ...
                          return (
                            <div className="p-4 bg-slate-950/95 backdrop-blur-xl border border-indigo-500/40 rounded-2xl shadow-[0_0_30px_rgba(0,0,0,0.8)] text-white text-xs space-y-2.5 min-w-[260px]">
            ...
            <div className="mt-5 pt-4 border-t border-slate-800 flex flex-wrap items-center justify-between gap-3 text-xs">
              <div className="flex flex-wrap items-center gap-4 font-mono">
                ...
                <div className="flex items-center gap-2 text-slate-300 font-bold">
                  <span className="w-3 h-3 rounded-sm bg-slate-500 border border-slate-400" />
                  <span>Meta (+5%)</span>
                </div>
                <div className="flex items-center gap-2 text-slate-300 font-bold">
                  <span className="w-3 h-0.5 bg-sky-400 shadow-[0_0_8px_#38bdf8]" />
                  <span>Mes Anterior</span>
                </div>
                <div className="flex items-center gap-2 text-slate-300 font-bold">
                  <span className="w-3 h-0.5 bg-amber-400 border-b border-dashed border-amber-400 shadow-[0_0_8px_#fbbf24]" />
                  <span>Año Anterior</span>
                </div>
              </div>
              <span className="text-xs text-indigo-400 font-mono font-bold">TELEMETRÍA PACING POSTGRES</span>
            </div>
          </div>

          {/* COLUMNA 2 (5 de 12): MIX DE CATEGORÍAS & RENTABILIDAD EJECUTIVA REDISEÑADA */}
          <div className="lg:col-span-5 p-8 rounded-3xl bg-slate-900/90 backdrop-blur-2xl border border-slate-800/90 shadow-[0_0_40px_rgba(0,0,0,0.5)] flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between mb-5">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-2xl bg-teal-500/20 text-teal-400 border border-teal-500/30 flex items-center justify-center font-bold shadow-[0_0_15px_rgba(20,184,166,0.3)]">
                    <PieChartIcon className="w-5 h-5" />
                  </div>
                  <div>
                    <h3 className="text-lg sm:text-xl font-black text-white tracking-tight">Mix de Categorías & Margen</h3>
                    <p className="text-xs text-slate-400">Distribución de facturación y rentabilidad</p>
                  </div>
                </div>
                <span className="px-3 py-1 rounded-full bg-teal-500/20 text-teal-300 text-xs font-mono font-black border border-teal-500/40 shadow-[0_0_10px_rgba(20,184,166,0.2)]">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-12 gap-5 items-center">
                ...
                <div className="sm:col-span-5 h-48 w-full relative flex items-center justify-center">
                  {categoryMixData.length === 0 ? (
                    <div className="h-full flex items-center justify-center text-xs text-slate-500 font-mono">Sin datos</div>
                  ) : (
                    <>
                      <ResponsiveContainer width="100%" height="100%">
                        <PieChart>
                ...
                <div className="sm:col-span-7 p-4 rounded-2xl bg-slate-950/80 border border-slate-800 space-y-2 shadow-inner">
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-mono font-bold text-slate-400">Familia Dominante:</span>
                    <span className="text-[10px] font-mono font-black px-2.5 py-0.5 rounded-md bg-indigo-500/20 text-indigo-300 border border-indigo-500/30">
                  ...
                  <div className="flex items-center justify-between text-xs font-mono pt-1 text-slate-300">
                    <span className="font-bold text-indigo-400">{formatCompactPYG(categoryMixData[0]?.value || 0)}</span>
              ...
              <div className="space-y-2 mt-4 max-h-56 overflow-y-auto pr-1">
                {categoryMixData.map((cat) => (
                  <div
                    key={cat.name}
                    className="p-3 rounded-2xl bg-slate-950/60 border border-slate-800/80 hover:border-teal-500/50 transition-all space-y-2 group"
                  >
                    <div className="flex items-center justify-between text-xs">
                      ...
                      <div className="flex items-center gap-2 shrink-0 font-mono">
                        <span className="px-2 py-0.5 rounded-md bg-slate-800 text-[10px] font-black text-slate-300 border border-slate-700">
                          {cat.percentage}%
                        </span>
            ...
            <div className="pt-4 mt-2 border-t border-slate-800 text-center">
              <button
                ...
                className="text-xs font-mono font-bold text-indigo-400 hover:text-indigo-300 inline-flex items-center gap-2 cursor-pointer"
              >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="p-8 rounded-3xl bg-slate-900/90 backdrop-blur-2xl border border-slate-800/90 shadow-[0_0_40px_rgba(0,0,0,0.5)] flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between mb-5">
                <h3 className="font-black text-sm text-white flex items-center gap-2.5">
              ...
              <div className="space-y-2.5 max-h-[380px] overflow-y-auto pr-1">
                {topProducts.length === 0 ? (
                  <div className="py-8 text-center text-xs text-slate-500 font-mono">Sin movimientos registrados en este período</div>
                ) : (
                  topProducts.map((p: any, idx: number) => {
                    const rankBadgeBg = idx === 0 ? "bg-amber-500 text-black font-black shadow-[0_0_15px_#f59e0b]" : idx === 1 ? "bg-slate-300 text-slate-900 font-black shadow-[0_0_10px_#cbd5e1]" : idx === 2 ? "bg-amber-700 text-white font-black" : "bg-slate-800 text-slate-400 border border-slate-700"
                    return (
                      <div key={idx} className="flex items-center justify-between p-3 rounded-2xl bg-slate-950/60 border border-slate-800/80 text-xs hover:border-indigo-500/50 transition-all">
                        ...
                        <div className="text-right shrink-0 font-mono">
                          <span className="font-black text-indigo-400 text-xs">{formatCompactPYG(p.monto)}</span>
                        </div>
                      </div>
                    )
                  })
            ...
            <div className="pt-4 mt-3 border-t border-slate-800 text-center">
              <button onClick={() => navigate("/products")} className="text-xs font-mono font-bold text-indigo-400 hover:text-indigo-300 cursor-pointer">
          ...
          <div className="p-8 rounded-3xl bg-slate-900/90 backdrop-blur-2xl border border-slate-800/90 shadow-[0_0_40px_rgba(0,0,0,0.5)] flex flex-col justify-between">
            <div>
              ...
              <div className="space-y-2.5 max-h-[380px] overflow-y-auto pr-1">
                {topCustomers.length === 0 ? (
                  <div className="py-8 text-center text-xs text-slate-500 font-mono">Sin compras registradas en este período</div>
                ) : (
                  topCustomers.map((c: any, idx: number) => {
                    const rankBadgeBg = idx === 0 ? "bg-amber-500 text-black font-black shadow-[0_0_15px_#f59e0b]" : idx === 1 ? "bg-slate-300 text-slate-900 font-black shadow-[0_0_10px_#cbd5e1]" : idx === 2 ? "bg-amber-700 text-white font-black" : "bg-slate-800 text-slate-400 border border-slate-700"
                    return (
                      <div key={idx} className="flex items-center justify-between p-3 rounded-2xl bg-slate-950/60 border border-slate-800/80 text-xs hover:border-purple-500/50 transition-all">
                        <div className="flex items-center gap-3 min-w-0 pr-2">
                          <span className={`w-6 h-6 rounded-xl flex items-center justify-center font-mono text-xs shrink-0 ${rankBadgeBg}`}>
                            {idx + 1}
                          </span>
                        ...
                        <div className="text-right shrink-0 font-mono">
                          <span className="font-black text-purple-400 text-xs">{formatCompactPYG(c.monto)}</span>
                        </div>
                      </div>
                    )
                  })
            ...
            <div className="pt-4 mt-3 border-t border-slate-800 text-center">
              <button onClick={() => navigate("/customers")} className="text-xs font-mono font-bold text-purple-400 hover:text-purple-300 cursor-pointer">
          ...
          <div className="p-8 rounded-3xl bg-slate-900/90 backdrop-blur-2xl border border-slate-800/90 shadow-[0_0_40px_rgba(0,0,0,0.5)] flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between mb-5">
                ...
                <span className="text-[10px] font-mono font-black px-2.5 py-1 rounded-full bg-amber-500/20 text-amber-300 border border-amber-500/40 shadow-[0_0_10px_rgba(245,158,11,0.2)]">
                  PERECEDEROS
                </span>
              </div>
              ...
              <div className="space-y-2.5 max-h-[380px] overflow-y-auto pr-1">
                {expiryAlerts.length === 0 ? (
                  <div className="py-8 text-center text-xs text-slate-500 font-mono">No hay lotes con alertas de vencimiento próximas</div>
                ) : (
                    ...
                    <div
                      ...
                      className={`p-3 rounded-2xl border text-xs flex items-center justify-between transition-all ${
                        exp.nivel === "critico"
                          ...
                          : exp.nivel === "alerta"
                          ? "bg-amber-950/40 border-amber-500/50 text-amber-200 shadow-[0_0_15px_rgba(245,158,11,0.15)]"
                          : "bg-teal-950/40 border-teal-500/40 text-teal-200"
                      }`}
                    >
                      <div className="min-w-0 pr-2">
                        <div className="flex items-center gap-1.5">
                          <span className="font-bold truncate text-white">{exp.nombre}</span>
                        </div>
                      ...
                      <div className="text-right shrink-0 font-mono">
                        <span
                          className={`inline-block px-2.5 py-1 rounded-lg font-black text-[10px] shadow-sm ${
                            exp.nivel === "critico"
            ...
            <div className="pt-4 mt-3 border-t border-slate-800 text-center">
              <button onClick={() => navigate("/inventory")} className="text-xs font-mono font-bold text-amber-400 hover:text-amber-300 cursor-pointer">
