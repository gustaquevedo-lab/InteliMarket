...
export default function DinelcoPage() {
  ...
  const [checkoutForm, setCheckoutForm] = useState({ monto: "", descripcion: "", order_id: "", customer_email: "", customer_name: "" })
  ...
  const handleCheckout = async () => {
    ...
    setCreating(true)
    try {
      const result = await api.dinelco.checkout(
        parseInt(checkoutForm.monto),
        checkoutForm.descripcion || `Pago orden ${checkoutForm.order_id}`,
        checkoutForm.order_id,
        checkoutForm.customer_email || undefined,
        checkoutForm.customer_name || undefined,
      )
      setCheckoutUrl(result.checkout_url || "")
      toast.success("Pago creado", "Redirigiendo al checkout de Dinelco...")
      setShowCheckout(false)
      setCheckoutForm({ monto: "", descripcion: "", order_id: "", customer_email: "", customer_name: "" })
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Financiación con tarjeta Dinelco</p>
        </div>
        ...
        <div className="modal-overlay" onClick={() => setShowCheckout(false)}>
          <div className="modal-content max-w-md" onClick={(e) => e.stopPropagation()}>
            <div className="flex items-center justify-between p-6 border-b border-gray-100 dark:border-gray-700">
              <h3 className="text-lg font-bold text-gray-900 dark:text-white">Nuevo cobro con Dinelco</h3>
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="input-label">Email cliente</label>
