...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { icon: Landmark, Sparkles, ShieldAlert, label: "Bóveda Central", path: "/boveda", feature: "supermercado" },
      { icon: Landmark, Sparkles, ShieldAlert, label: "Cuentas por Cobrar", path: "/accounts-receivable" },
      ...
      { icon: Landmark, Sparkles, ShieldAlert, label: "Cheques y Pagarés", path: "/checks", feature: "credit_accounts" },
