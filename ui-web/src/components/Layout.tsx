...
import {
  ...
  Tags, Warehouse, Scale, ShoppingBag, Briefcase, Banknote, Landmark, Sparkles, CreditCard, Wallet, ReceiptText,
...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { icon: Landmark, Sparkles, label: "Bóveda Central", path: "/boveda", feature: "supermercado" },
      { icon: Landmark, Sparkles, label: "Cuentas por Cobrar", path: "/accounts-receivable" },
      ...
      { icon: Landmark, Sparkles, label: "Cheques y Pagarés", path: "/checks", feature: "credit_accounts" },
