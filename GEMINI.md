...
2. **EXCLUSIVAMENTE SUPERMERCADO (EXTRA SUPERMERCADO):** Olvidar por completo la rama distribuidora, Casa Gonzalito y servidores de terceros (como minisforum). Solo se trabaja la vertical de Supermercado con la VM `intellihouse@100.83.91.76`.
3. **NO MEZCLAR DATOS NI VARIABLES:** Toda la interfaz, reportes, datos fiscales (RUC `80092451-2` / Timbrado `18545636` / Extra Supermercado) y reglas de negocio deben responder a la vertical de Retail & Supermercado.
