...
VERTICALS: dict[str, VerticalPreset] = {
    ...
    "boutique": VerticalPreset(
        ...
        descripcion="Para boutiques, indumentaria y moda. Colecciones por temporada, matriz talle×color, clienteling, loyalty tiers, markdown IA, AR try-on, eventos, gift wrapping.",
        features=[
            "pos", "crm", "inventory", "sales", "purchases", "payments",
            "reports", "sifen", "caja", "branches",
            "variants", "quotes", "price_lists", "imports",
            "rbac", "notifications", "whatsapp", "email",
            "discounts", "returns", "loyalty",
            # Boutique-specific
            "boutique_pedidos",
            "intelientregas",
            "boutique",
        ...
        config_defaults={
            ...
            "tipo_comprobante_default": "ticket",
            "allow_credit_sales": True,
            "invoice_after_delivery": False,
            "track_lots": False,
            "track_expiry": False,
            "boutique_temporada_actual": "otonio_invierno",
            "boutique_anio_actual": 2026,
        },
        payment_gateways=["pagopar", "kuapay", "bancard", "spi", "dinelco"],
        icon="shirt",
    ),
