...
class Cheque(Base):
    ...
    receivable_payment_id = Column(UUID(as_uuid=True), index=True)
    tipo_cheque = Column(String(20), default="emitido")  # emitido (a proveedor) | recibido (de cliente)
    librador_nombre = Column(String(200))
    librador_documento = Column(String(50))
